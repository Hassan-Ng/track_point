...
<?php $__env->startSection('title', 'Create User | Track Point'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <main class="flex-1 overflow-y-auto flex items-center text-sm justify-center fade-in">
        <div class="main-child grow">
            ...
            <!-- Form -->
            <form id="form" action="<?php echo e(route('users.store')); ?>" method="post" enctype="multipart/form-data"
                class="bg-[--secondary-bg-color] rounded-xl shadow-xl p-8 border border-gray-600 pt-12 max-w-2xl mx-auto relative overflow-hidden">
                <?php echo csrf_field(); ?>
                <div
...
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="text-[--border-error] mt-1"><?php echo e($message); ?></div>
                            <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/user/create-user.blade.php ENDPATH**/ ?>