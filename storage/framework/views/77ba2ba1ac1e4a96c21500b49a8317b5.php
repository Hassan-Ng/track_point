...
<?php $__env->startSection('title', 'Add Article | Track Point'); ?>
    ...
    <main class="flex-1 overflow-y-auto flex items-center justify-center">
        <div class="main-child grow">
            ...
            <div class="row max-w-5xl mx-auto flex gap-4">
                <!-- Form -->
                <form id="form" method="POST" action="<?php echo e(route('article.store')); ?>" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <input id="article_no" type="number" name="article_no"
                                    ...
                                    value="<?php echo e(old('article_no')); ?>" />
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="text-[--border-error] text-xs mt-1"><?php echo e($message); ?></div>
                                <?php unset($message);
                                ...
                                <div class="relative">
                                    <select id="category" name="category_id"
                                        ...
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($type->type === 'pcs_category'): ?>
                                                <option value="<?php echo e(str_replace(' ', '-', $type->id)); ?>"
                                                    <?php echo e(old('category_id') == $type->id ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <select id="size" name="size_id"
                                        ...
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($type->type === 'pcs_size'): ?>
                                                <option value="<?php echo e(str_replace(' ', '-', $type->id)); ?>"
                                                    <?php echo e(old('size_id') == $type->id ? 'selected' : ''); ?>>
                                                    <?php echo e($type->title); ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <select id="season" name="season_id"
                                        ...
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($type->type === 'pcs_season'): ?>
                                                <option value="<?php echo e(str_replace(' ', '-', $type->id)); ?>"
                                                    <?php echo e(old('season_id') == $type->id ? 'selected' : ''); ?>>
                                                    <?php echo e($type->title); ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input id="extra_pcs" type="number" name="extra_pcs"
                                    class="w-full rounded-lg bg-[--h-bg-color] border-gray-600 text-[--text-color] text-sm px-3 py-2 border focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 ease-in-out"
                                    value="<?php echo e(old('extra_pcs')); ?>" />
                                <?php $__errorArgs = ['extra_pcs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input id="fabric_type" type="text" name="fabric_type"
                                    class="w-full rounded-lg bg-[--h-bg-color] border-gray-600 text-[--text-color] text-sm px-3 py-2 border focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 ease-in-out"
                                    value="<?php echo e(old('fabric_type')); ?>" />
                                <?php $__errorArgs = ['fabric_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled
                                        ...
                                        value="<?php echo e($lastRecord->fabric_type); ?>" />
                                </div>
                            </div>
                        <?php else: ?>
                    ...
                    <div class="step2 hidden space-y-6  h-full text-sm flex flex-col">
                        <?php if($lastRecord): ?>
                            <div class="w-full text-left grow">
                                ...
                                <div id="rate-list" class="space-y-4 h-[250px] overflow-y-auto my-scroller-2">
                                    <?php if(count($lastRecord->rates_array) === 0): ?>
                                        <div class="text-center bg-[--h-bg-color] rounded-lg py-2 px-4">No Rates Added
                                        </div>
                                    <?php else: ?>
                                        <?php $__currentLoopData = $lastRecord->rates_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $lastRecord->total_rate += $rate['rate'];
                                            ?>
                                            <div
                                                class="flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4">
                                                <div class="grow ml-5"><?php echo e($rate['title']); ?></div>
                                                <div class="w-1/4"><?php echo e(number_format($rate['rate'], 2, '.', '')); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="flex flex-col w-full gap-4">
                                <div
                                    ...
                                    <div class="w-1/4 text-right"><?php echo e(number_format($lastRecord->total_rate, 2, '.', '')); ?>
                                ...
                                <div
                                    class="flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4 w-full">
                                    <div class="text-nowrap grow">Sales Rate - Rs.</div>
                                    <div class="w-1/4 text-right"><?php echo e(number_format($lastRecord->sales_rate, 2, '.', '')); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-1">
                                <div
                                    ...
                                    <input id="image_upload" type="file" name="image_upload" accept="image/*"
                                        class="hidden" onchange="previewImage(event)" />
                                    <div id="image_preview" class="flex flex-col items-center max-w-[50%]">
                                        <img src="<?php echo e(asset('storage/uploads/images/' . $lastRecord->image)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/article/add-article.blade.php ENDPATH**/ ?>