...
<?php $__env->startSection('title', 'Show Users | Track Point'); ?>
<?php $__env->startSection('content'); ?>
        ...
        <div class="bg-[--secondary-bg-color] rounded-lg shadow-lg w-full max-w-lg p-6 relative">
            ...
            <div id="modal_body" class="modal_body flex items-start">
                <div class="flex text-[--border-error] rounded-full w-[30%] aspect-square overflow-hidden">
                    <img id="userImage" src="<?php echo e(asset('/storage/uploads/images/default_avatar.png')); ?>" alt=""
            ...
            <div class="flex justify-end space-x-3">
                ...
                <form method="POST" action="<?php echo e(route('update-user-status')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <!-- Main Content -->
    <main class="flex-1 overflow-y-auto text-sm flex items-center justify-center fade-in">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div data-user="<?php echo e($user); ?>"
                                    ...
                                    <div class="img aspect-square h-full rounded-full overflow-hidden">
                                        <img src="<?php echo e(asset('storage/uploads/images/' . $user->profile_picture)); ?>"
                                    ...
                                    <div class="details text-start">
                                        ...
                                        <p class="text-[--secondary-text] tracking-wide"><strong>Username:</strong>
                                            <span class="username"><?php echo e($user->username); ?></span>
                                        </p>
                                        <p class="text-[--secondary-text] tracking-wide capitalize">
                                            <strong>Role:</strong> <span class="role"><?php echo e($user->role); ?></span>
                                        </p>
                                    </div>
                                    <button
                                        class="absolute bottom-0 right-0 rounded-full w-[25%] aspect-square flex items-center justify-center bg-[--h-bg-color] text-lg translate-x-1/4 translate-y-1/4">
                                        <i class='bx bx-right-arrow-alt text-3xl -rotate-45'></i></button>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/user/index.blade.php ENDPATH**/ ?>