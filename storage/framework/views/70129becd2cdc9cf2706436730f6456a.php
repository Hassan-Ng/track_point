...
<?php $__env->startSection('title', 'Show Articles | Track Point'); ?>
<?php $__env->startSection('content'); ?>
    <?php $authLayout = Auth::user()->layout; ?>
    <!-- Modals -->
    ...
    <div id="articleModal"
        ...
        <div class="bg-[--secondary-bg-color] rounded-2xl shadow-lg w-[65rem] h-[30rem] p-5 relative">
            ...
            <div id="modal_body" class="modal_body flex items-start gap-6 w-full h-full">
                <div class="flex text-[--border-error] rounded-lg aspect-square overflow-hidden relative h-full">
                    <img id="articleImage"
                        src="<?php echo e(asset('/storage/uploads/images/1737209701_d2a447c86aa8f6f2f1ed542ab1c07377.jpg')); ?>"
        ...
        <div id="modal-action"
            ...
            <div class="flex w-full gap-4">
                <a id="track-article-in-modal" href="<?php echo e(route('article-track')); ?>"
    ...
    <div id="addImageModal"
        ...
        <form method="POST" action="<?php echo e(route('add-image')); ?>" enctype="multipart/form-data" class="w-full h-full flex flex-col space-y-4 items-center justify-center">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grow">
                                <div
                                    ...
                                    <div id="image_preview" class="flex flex-col items-center max-w-[50%]">
                                        <img src="<?php echo e(asset('storage/uploads/images/image_icon.png')); ?>" alt="Upload Icon"
    ...
    <main class="flex-1 overflow-y-auto flex items-center text-sm justify-center">
        <div class="main-child grow">
            ...
            <!-- Search Form -->
            <form id="search-form" method="GET" action="<?php echo e(route('article.index')); ?>" autocomplete="off"
                ...
                <div class="filter-box flex flex-1 items-center gap-4">
                    ...
                    <div class="filter-select relative w-full">
                        <select name="season" id="season"
                            ...
                            <option value="all" <?php echo e(request('season') === 'all' ? 'selected' : ''); ?>>All Seasons</option>
                            <?php $__currentLoopData = $seasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $season): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($season->id); ?>"
                                    <?php echo e(request('season') == $season->id ? 'selected' : ''); ?>><?php echo e($season->title); ?></option>
                    ...
                    <div class="filter-select relative w-full">
                        <select name="size" id="size"
                            ...
                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($size->id); ?>" <?php echo e(request('size') == $size->id ? 'selected' : ''); ?>>
                                    <?php echo e($size->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="filter-select relative w-full">
                        <select name="category" id="category"
                            class="w-full px-4 py-2 rounded-lg bg-[--h-bg-color] text-[--text-color] placeholder-[--text-color] appearance-none focus:outline-none focus:ring-2 focus:ring-[--primary-color] focus:ring-opacity-50">
                            <option value="all" <?php echo e(request('category') === 'all' ? 'selected' : ''); ?>>All Categories
                            </option>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>"
                                    <?php echo e(request('category') == $category->id ? 'selected' : ''); ?>><?php echo e($category->title); ?>
            ...
            <section class="text-center mx-auto ">
                <div
                    class="show-box mx-auto w-[80%] h-[70vh] bg-[--secondary-bg-color] rounded-xl shadow overflow-y-auto <?php if($authLayout == 'grid'): ?> pt-7 pr-2 <?php endif; ?> relative">
                    <?php if($authLayout == 'grid'): ?>
                        <div
                    ...
                    <div class="buttons absolute <?php echo e($authLayout == 'grid' ? 'top-0' : 'top-0.5'); ?> right-4 text-sm">
                        <div class="relative group">
                            <form method="POST" action="<?php echo e(route('update-user-layout')); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="layout" value="<?php echo e($authLayout); ?>">
                                ...
                                <?php if($authLayout == 'grid'): ?>
                                    <div
                                        ...
                                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-article="<?php echo e($article); ?>"
                                            ...
                                            <div data-article="<?php echo e($article); ?>"
                                                ...
                                                <?php if($article->image == 'no_image_icon.png'): ?>
                                                    ...
                                                    <div
                                                        ...
                                                        No Image</div>
                                                <?php endif; ?>
                                                <div class="p-2">#<?php echo e($article->article_no); ?></div>
                                                <div class="p-2"><?php echo e($article->season->title); ?></div>
                                                <div class="p-2"><?php echo e($article->size->title); ?></div>
                                                <div class="p-2"><?php echo e($article->category->title); ?></div>
                                                <div class="p-2"><?php echo e($article->sales_rate); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
                ...
                <div class="context-menu absolute top-0 left-0 text-sm z-50" style="display: none;">
                    <div
                        ...
                        <ul class="p-2">
                            ...
                            <li>
                                <a id="track-article" href="<?php echo e(route('article-track')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/article/index.blade.php ENDPATH**/ ?>