                    ...
                    <div class="article_image absolute -left-[17rem] top-0 bg-[--secondary-bg-color] rounded-xl shadow-xl border border-gray-600 p-4 overflow-hidden max-w-sm w-[15rem] transition-all 0.3s ease-in-out opacity-0">
                        <div class="img aspect-square h-full rounded-md overflow-hidden">
                            ...
                            <div class="error hidden h-full flex flex-col items-center justify-center">
                                <img src="<?php echo e(asset('storage/uploads/images/error_icon.png')); ?>" alt=""
                            ...
                            <div class="relative">
                                <select id="customer" name="customer_id"
                                    ...
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(str_replace(' ', '-', $customer->id)); ?>" last-invoice="<?php echo e($last_invoice); ?>"
                                            person-name="<?php echo e($customer->person_name); ?>" customer-data="<?php echo e($customer); ?>">
                        ...
                        <div class="flex justify-between gap-4">
                            <div class="form-group grow relative">
                                ...
                                <datalist id="article_list">
                                    <?php $__currentLoopData = $articlesNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articleNo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($articleNo->article_no); ?>"></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </datalist>
                            </div>          
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/invoices/create-invoice.blade.php ENDPATH**/ ?>