...
<?php $__env->startSection('title', 'Article Track | Track Point'); ?>
                    ...
                    <div class="filter-select relative w-full grow">
                        <select id="article"
                            ...
                            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($article->id); ?>">#<?php echo e($article->article_no); ?> | <?php echo e($article->category->title); ?> | <?php echo e($article->season->title); ?> | <?php echo e($article->size->title); ?> | <?php echo e($article->fabric_type); ?></option>
                ...
                <div class="show-box mx-auto w-[80%] h-[70vh] bg-[--secondary-bg-color] rounded-xl shadow-md relative overflow-y-hidden">
                    <div id="table_container" class="rounded-tl-lg rounded-tr-lg h-full text-sm flex flex-col">
                        ...
                        <div id="table-body" class="table-body overflow-y-auto my-scroller-2 grow">
                            ...
                            <?php if( isset($filteredInvoices) && count($filteredInvoices) > 0 ): ?>
                                <?php $__currentLoopData = $filteredInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="modalToggle flex text-center text-xs border-b border-gray-600 items-center py-1 cursor-pointer hover:bg-[--h-secondary-bg-color] transition-all ease-in-out fade-in">
                                        <div class="p-2 w-5"><?php echo e($key + 1); ?>.</div>
                                        <div class="p-2 w-full"><?php echo e($invoice->date); ?></div>
                                        <div class="p-2 w-full gorw"><?php echo e($invoice->customer->customer); ?> | <?php echo e($invoice->customer->city); ?></div>
                                        <div class="p-2 w-1/2"><?php echo e($invoice->invoice_no); ?></div>
                                        <div class="p-2 w-1/2"><?php echo e($invoice->articles_array['quantity']); ?></div>
                                        <div class="p-2 w-1/2"><?php echo e(number_format($invoice->rate, 2, '.', ',')); ?></div>
                                        <div class="p-2 w-1/2"><?php echo e(number_format(($invoice->article['sales_rate'] * $invoice->articles_array['quantity']), 1, '.', ',')); ?></div>
                                        <div class="p-2 w-1/2"><?php echo e($invoice->discount); ?>%.</div>
                                        <div class="p-2 w-1/2"><?php echo e(number_format((($invoice->article['sales_rate'] * $invoice->articles_array['quantity']) - (($invoice->article['sales_rate'] * $invoice->articles_array['quantity']) * ($invoice->discount / 100))), 1, '.', ',')); ?></div>
                                    </div>
                                    <?php
                        ...
                        <div id="calc-bottom" class="flex w-full gap-4 p-5 text-sm">
                            <div class="total flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4 w-full">
                                ...
                                <div class="grow text-right"><?php echo e($totalQuantity); ?> - Pcs.</div>
                            </div>
                            <div class="final flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4 w-full">
                                ...
                                <div id="total-amount" class="grow text-right"><?php echo e($soldQuantity); ?> - Pcs.</div>
                            </div>
                            <div class="final flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4 w-full">
                                <div class="text-nowrap">Available Stock</div>
                                <div id="total-amount" class="grow text-right"><?php echo e($totalQuantity - $soldQuantity); ?> - Pcs.</div>
                            </div>
                            <div class="final flex justify-between items-center bg-[--h-bg-color] rounded-lg py-2 px-4 w-full">
                                <div class="text-nowrap">Total Balnce (Rs.)</div>
                                <div id="net-amount" class="grow text-right"><?php echo e(number_format($totalBalance, 1, '.', ',')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/article/article-track.blade.php ENDPATH**/ ?>