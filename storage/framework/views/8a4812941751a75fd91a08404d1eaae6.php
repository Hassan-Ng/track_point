...
<?php $__env->startSection('content'); ?>
    ...
    <div id="customerModal"
        class="hidden fixed inset-0 z-50 flex items-center justify-center text-sm fade-in bg-black bg-opacity-50">
        <!-- Modal Content -->
        <div class="bg-[--secondary-bg-color] rounded-xl shadow-lg w-full max-w-2xl p-6 relative flex">
            ...
            <div class="flex text-[--border-error] rounded-full h-[15rem] aspect-square overflow-hidden">
                ...
                <img id="customerImage" src="<?php echo e(asset('/storage/uploads/images/default_avatar.png')); ?>" alt=""
            ...
            <div id="modal-contant" class="grow h-[15rem] flex flex-col justify-between">
                ...
                <div class="flex justify-end space-x-3 mt-5">
                    <div class="btns flex gap-3">
                        <!-- Cancel Button -->
                        <a id="show-statement-modal" href="<?php echo e(route('customer-statement')); ?>"
                            class="px-4 py-2 bg-[--secondary-bg-color] border text-[--secondary-text] rounded-md hover:bg-[--bg-color] transition-all 0.3s ease-in-out">Show
                            Statement</a>

                        <form method="POST" action="<?php echo e(route('update-customer-status')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" id="customer_id" name="customer_id" value="">
                            <input type="hidden" id="customer_status" name="status" value="">
                            <button id="ac_in_btn" type="submit"
                                class="px-4 py-2 bg-[--danger-color] text-white rounded-md hover:bg-[--h-danger-color] transition-all 0.3s ease-in-out">In
                                Active</button>
                        </form>
                    </div>
                </div>
    ...
    <main class="flex-1 overflow-y-auto flex items-center justify-center fade-in">
        <div class="main-child grow">
            ...
            <!-- Search Form -->
            <form id="search-form" method="GET" action="<?php echo e(route('customer.index')); ?>"
                ...
                <div class="search-input relative flex-1">
                    <input type="text" id="customer_input" name="customer" placeholder="Enter Customer."
                        list="customer_list" autocomplete="off" value="<?php echo e(request('search')); ?>"
                    ...
                    <datalist id="customer_list">
                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($customer->customer); ?>"></option>
            ...
            <section class="text-center mx-auto fade-in">
                <div
                    class="show-box mx-auto w-[80%] h-[70vh] bg-[--secondary-bg-color] rounded-xl text-sm shadow overflow-y-auto <?php if(Auth::user()->layout == 'grid'): ?> pt-7 pr-2 <?php endif; ?> relative">
                    <?php if(Auth::user()->layout == 'grid'): ?>
                        <div
                            ...
                            <div class="container-parent h-full overflow-y-auto my-scroller">
                                <?php if(Auth::user()->layout == 'grid'): ?>
                                    <div
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-customer="<?php echo e($customer); ?>"
                                                ...
                                                <div class="img aspect-square h-full rounded-full overflow-hidden">
                                                    <img src="<?php echo e(asset('storage/uploads/images/' . $customer->image)); ?>"
                                                ...
                                                <div class="text-start">
                                                    <h5 class="text-xl my-1 text-[--text-color] capitalize font-semibold">
                                                        <?php echo e($customer->customer); ?></h5>
                                                    <p class="text-[--secondary-text] tracking-wide text-sm">
                                                        <strong>City:</strong>
                                                        <span class="person_name"><?php echo e($customer->city); ?></span>
                                                    </p>
                                                    <p class="text-[--secondary-text] tracking-wide text-sm capitalize">
                                                        <strong>Phone:</strong> <span
                                                            class="phone"><?php echo e(substr($customer->phone, 0, 4) . '-' . substr($customer->phone, 4, 7)); ?></span>
                                                    </p>
                                                    <p class="text-[--secondary-text] tracking-wide text-sm capitalize">
                                                        <strong>Balance:</strong> <span
                                                            class="phone"><?php echo e($customer->balance); ?></span>
                                                    </p>
                                                </div>
                                                <button
                                    ...
                                    <div class="table_container rounded-tl-lg rounded-tr-lg overflow-hidden text-sm">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-customer="<?php echo e($customer); ?>"
                                                ...
                                                <div class="p-2"><?php echo e($customer->customer); ?></div>
                                                <div class="p-2"><?php echo e($customer->city); ?></div>
                                                <div class="p-2">
                                                    <?php echo e(substr($customer->phone, 0, 4) . '-' . substr($customer->phone, 4, 7)); ?>

                                                </div>
                                                <div class="p-2"><?php echo e($customer->balance); ?></div>
                                                <div class="p-2">
                                                    <?php if($customer->status === 'active'): ?>
            ...
            <div class="context-menu absolute top-0 text-sm" style="display: none;">
                <div
                    ...
                    <ul class="p-2">
                        ...
                        <li>
                            <a id="show-statment" href="<?php echo e(route('customer-statement')); ?>"
                                class="flex items-center w-full px-4 py-2 text-left hover:bg-[--h-bg-color] rounded-md transition-all 0.3s ease-in-out">Show
                                Statement</a>
                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/customer/index.blade.php ENDPATH**/ ?>