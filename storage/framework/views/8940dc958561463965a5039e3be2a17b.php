<?php $__env->startSection('title', 'Home | Track Point'); ?>
                        ...
                        <div class="banner flex w-full h-[14rem] bg-[--primary-color] shadow-lg rounded-2xl relative overflow-hidden">
                            <div class="left w-[50%]">
                                <div class="content w-full h-full py-12 pl-14 relative">
                                    <h1 class="text-4xl font-bold capitalize mb-1">Hi, <?php echo e(Auth::user()->name); ?></h1>
                            ...
                            <div class="right w-[50%] h-full">
                                <div class="image w-full h-full relative">
                                    <img src="<?php echo e(asset('storage/uploads/images/dashboard_banner.png')); ?>" alt="" class="h-[95%] absolute -bottom-1 -right-3">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/home.blade.php ENDPATH**/ ?>