...
<?php $__env->startSection('title', 'Show Payments | Track Point'); ?>
<?php $__env->startSection('content'); ?>
        ...
        <div class="bg-[--secondary-bg-color] rounded-2xl shadow-lg w-[1024px] h-[450px] p-5 relative">
            ...
            <div id="modal_body" class="modal_body flex items-start gap-6 w-full h-full">
                <div class="flex rounded-lg aspect-square overflow-hidden relative h-full p-5">
                    <img id="invoiceImage" src="<?php echo e(asset('/storage/uploads/images/payment_icon.png')); ?>" alt=""
                        class="h-full w-full object-cover">
                    <div id="invoice_dot"
                        class="invoice_dot absolute top-2 left-2 w-[0.7rem] h-[0.7rem] bg-[--border-success] rounded-full shadow-md">
                    </div>
                </div>
    ...
    <main class="flex-1 overflow-y-auto flex items-center text-sm justify-center fade-in">
        <div class="main-child grow">
            ...
            <!-- Search Form -->
            <form id="search-form" method="GET" action="<?php echo e(route('payment.index')); ?>"
                ...
                <div
                    ...
                    <?php if(count($payments) > 0): ?>
                        <div
                            ...
                            <a href="<?php echo e(route('payment.create')); ?>"
                                ...
                                <?php if($authLayout == 'grid'): ?>
                                    <div
                                        ...
                                        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-payment="<?php echo e($payment); ?>"
                                                ...
                                                <div class="img aspect-square h-full rounded overflow-hidden p-3">
                                                    <img src="<?php echo e(asset('storage/uploads/images/payment_icon.png')); ?>"
                                                        alt="" class="w-full h-full object-cover">
                                                    <?php if($payment->type == 'cheque' || $payment->type == 'slip' && $payment->clear_date == 'Pending'): ?>
                                    ...
                                    <div class="table_container rounded-tl-lg rounded-tr-lg overflow-hidden text-sm">
                                        ...
                                        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-payment="<?php echo e($payment); ?>"
                                                ...
                                                <?php if($payment->image == 'no_image_icon.png'): ?>
                                                    <div
                                                    ...
                                                    <div
                                                        ...
                                                        No Image</div>
                                                <?php endif; ?>
                                                <div class="p-2"><?php echo e($payment->customer->customer); ?></div>
                                                <div class="p-2"><?php echo e($payment->date); ?></div>
                                                <div class="p-2 capitalize"><?php echo e($payment->type); ?></div>
                                                <div class="p-2"><?php echo e($payment->amount); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/payments/index.blade.php ENDPATH**/ ?>