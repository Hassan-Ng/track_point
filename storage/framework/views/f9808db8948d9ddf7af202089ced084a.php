...
<?php $__env->startSection('title', 'Add Customer | Track Point'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <main class="flex-1 overflow-y-auto flex items-center justify-center fade-in">
        <div class="main-child grow">
            ...
            <!-- Form -->
            <form id="form" action="<?php echo e(route('customer.store')); ?>" method="post" enctype="multipart/form-data"
                ...
                <div class="step1 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="customer" name="customer" value="<?php echo e(old('customer', 'M/s ')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="person_name" name="person_name"
                                value="<?php echo e(old('person_name', 'Mr. ')); ?>"
                                class="w-full rounded-lg bg-[--h-bg-color] border-gray-600 text-[--text-color] px-3 py-2 border focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 ease-in-out"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/customer/add-customer.blade.php ENDPATH**/ ?>