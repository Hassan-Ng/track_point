...
<aside class="bg-[--secondary-bg-color] w-16 flex flex-col items-center py-5 h-screen shadow-lg z-40 fade-in">
            ...
            <div class="relative group">
                ...
                <div id="menu2"
                    ...
                    <ul class="p-2">
                        ...
                        <li>
                            <a href="<?php echo e(route('customer-statement')); ?>"
            ...
            <div class="relative group">
                ...
                <div id="menu3"
                    ...
                    <ul class="p-2">
                        ...
                        <li>
                            <a href="<?php echo e(route('article-track')); ?>"
                                class="block px-4 py-2 hover:bg-[--h-bg-color] rounded-md transition-all duration-200 ease-in-out">
                                Article Track
                            </a>
                        </li>
    ...
    <div class="relative group pt-3 mt-auto">
        ...
        <button id="trigger999"
            ...
            <img src="<?php echo e(asset('storage/uploads/images/' . auth()->user()->profile_picture)); ?>"
        ...
        <div id="menu999"
            ...
            <ul class="p-2">
                <!-- Add Setups -->
                <li>
                    <a href="<?php echo e(route('addSetups')); ?>"
                        class="block px-4 py-2 hover:bg-[--h-bg-color] rounded-md transition-all duration-200 ease-in-out">
...
<?php /**PATH E:\Softwares\TrackPoint\resources\views/layouts/components/sidebar.blade.php ENDPATH**/ ?>