...
<?php $__env->startSection('title', 'Show Invoice | Track Point'); ?>
...
<?php $authLayout = Auth::user()->layout; ?>
    ...
    <div id="InvoiceModal"
        ...
        <div class="bg-white rounded-xl shadow-lg relative">
            ...
            <div id="btns" class="buttons absolute bottom-8 right-5 flex gap-3">
                <div class="relative group">
                    <!-- Main Button -->
                    <a id="trigger1" class="dropdown-trigger bg-[--primary-color] p-3 group cursor-pointer rounded-full">
                        <i class='bx bxs-file-export text-lg'></i>
                        <span
                            class="absolute shadow-xl left-12 top-0 bg-[--secondary-bg-color] text-[--text-color] text-[12px] rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                            Export
                        </span>
                    </a>
                    <!-- Dropdown Menu -->
                    <div id="menu1"
                        class="dropdownMenu absolute bottom-0 left-12 text-left hidden border border-gray-600 w-48 bg-[--secondary-bg-color] text-[--text-color] text-[12px] shadow-lg rounded-lg opacity-0 transform scale-95 transition-all duration-300 ease-in-out z-50">
                        <ul class="p-2">
                            <li>
                                <button id="printInvoice" type="button"
                                    class="w-full text-left block px-4 py-2 hover:bg-[--h-bg-color] rounded transition-all duration-200 ease-in-out">
                                    Print
                                </button>
                            </li>
                            <li>
    ...
    <main class="flex-1 overflow-y-auto flex items-center text-sm justify-center fade-in">
        <div class="main-child grow">
            ...
            <!-- Search Form -->
            <form id="search-form" method="GET" action="<?php echo e(route('invoice.index')); ?>"
                        ...
                        <select name="customer" id="customer"
                            ...
                            <?php if(isset($customers)): ?>
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->customer); ?> | <?php echo e($customer->city); ?></option>
                                ...
                                <?php if($authLayout == 'grid'): ?>
                                    <div
                                        ...
                                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-invoice="<?php echo e($invoice); ?>"
                                                ...
                                                <div class="text-start">
                                                    ...
                                                    <p class="text-[--secondary-text] text-sm"><strong
                                                            ...
                                                            class="season"><?php echo e($invoice->date); ?></span></p>
                                                    <p class="text-[--secondary-text] text-sm"><strong
                                                            class="font-medium">Customer:</strong> <span
                                                            class="size"><?php echo e($invoice->customer->customer); ?></span></p>
                                                    <p class="text-[--secondary-text] text-sm mt-"><strong
                                                            class="font-medium">Net Amount:</strong> <span
                                                            class="sales-rate"><?php echo e($invoice->net_amount); ?></span></p>
                                                </div>
                                                <button
                                    ...
                                    <div class="table_container rounded-tl-lg rounded-tr-lg overflow-hidden text-sm">
                                        ...
                                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-invoice="<?php echo e($invoice); ?>"
                                                ...
                                                <?php if($invoice->image == 'no_image_icon.png'): ?>
                                                    <div
                                                    ...
                                                    <div
                                                        ...
                                                        No Image</div>
                                                <?php endif; ?>
                                                <div class="p-2"><?php echo e($invoice->invoice_no); ?></div>
                                                <div class="p-2"><?php echo e($invoice->date); ?></div>
                                                <div class="p-2"><?php echo e($invoice->customer->customer); ?></div>
                                                <div class="p-2"><?php echo e($invoice->net_amount); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
                ...
                <div id="invoice-banner" class="invoice-banner w-full flex justify-between mt-8 px-5">
                    <div class="left w-50">
                        <div class="invoice-logo">
                            <img src="<?php echo e(asset('storage/uploads/images/Spark-Pair1.png')); ?>" alt="Track Point"
                                class="w-[150px]" />
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Softwares\TrackPoint\resources\views/invoices/index.blade.php ENDPATH**/ ?>